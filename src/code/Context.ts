...
/** @internal **/
export const context: IModuleContext = new ModuleContext("intellivisa-redapp-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('intellivisa-redapp-web-module/translations');
